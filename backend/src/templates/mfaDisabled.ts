export const MFADisabledTemplate = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Two-Factor Authentication Disabled - Nexweb</title>
</head>
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin-top: 0; margin-bottom: 20px; color: #333333; font-size: 24px;">Two-Factor Authentication Disabled</h2>
                            <p style="margin-bottom: 25px; font-size: 16px; line-height: 1.5; color: #555555;">
                                Hello {name},
                            </p>
                            <p style="margin-bottom: 25px; font-size: 16px; line-height: 1.5; color: #555555;">
                                This is an important security notification that two-factor authentication (2FA) has been <strong>disabled</strong> on your Nexweb account.
                            </p>
                            
                            <!-- 2FA Disabled Warning Box -->
                            <div style="background-color: #fef2f2; border-radius: 8px; padding: 20px; text-align: center; margin: 30px 0; border: 1px solid #fecaca;">
                                ...
                                <p style="margin: 10px 0 0; font-size: 14px; color: #666666;">Two-factor authentication is no longer protecting your account</p>
                            </div>
                            
                            <p style="margin-bottom: 25px; font-size: 16px; line-height: 1.5; color: #555555;">
                                <strong>Important:</strong> Without two-factor authentication, your account is more vulnerable to unauthorized access. We strongly recommend re-enabling this security feature to protect your account.
                            </p>
